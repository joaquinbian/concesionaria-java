...
public class EditarAuto extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(144, 144, 144)
                        .addComponent(editarBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
       ...
       // controladora.guardarAuto(marca, modelo, color, motor, patente, cantidadPuertas);
        controladora.editarAuto(this.auto, marca, modelo, color, motor, patente, cantidadPuertas);
        
        mostrarMensaje("Se ha editado tu auto correctamente", "Guardar auto");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Automovil auto = controladora.obtenerAuto(this.id);
        this.auto = auto;
        
       
        String puertas = auto.getCantidadPuertas() == 0 ? "-" : String.valueOf(auto.getCantidadPuertas());
        cantidadPuertasCombo.setSelectedItem(puertas);
        colorTextField.setText(auto.getColor());
        marcaTextField.setText(auto.getMarca());
        modeloTextField.setText(auto.getModelo());
        motorTextField.setText(auto.getMotor());
